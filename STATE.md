...
Updated: 2026-07-22
Current phase: v0.3 published to `main`; workbench growth (importable NFL,
vendored GS, debate landscape anchor). BY-012 and BY-033 bridges `REVIEWED`
...
<!-- Generated by scripts/generate_registry_views.py; do not edit by hand. -->
- Package version: **`0.3.0`** (`lakefile.toml`, cross-checked against `CITATION.cff`).
- Latest recorded release note: [`docs/releases/v0.3.md`](docs/releases/v0.3.md).
...
- v0.3 is published on `main`; ongoing work lands via focused branches and
  squash-merged pull requests (see `CONTRIBUTING.md`).
- Pre-squash per-release history is preserved locally under
  `archive/agent-work-v0.{1,2,3}-pre-squash`.
## Blocked
...
1. CT-6: first native possibility proof — continuous free lunches (BY-022),
   where the finite NFL symmetry provably fails.
