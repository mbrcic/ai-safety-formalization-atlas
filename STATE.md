...
- Registry Lean declarations: **41** (WRAPPER **12** / BRIDGE **4**); landscape adds its own.
- Landscape formalizations: **17** (**8** on the public root import).
...
- **What is formalized and how it is graded** — [`registry.yaml`](registry.yaml),
  [`landscape.yaml`](landscape.yaml), and the generated
