...
The public import surface for the atlas. Modules imported here must compile
without `sorry` and must distinguish mathematical results from AI-safety bridge
claims.
-/
