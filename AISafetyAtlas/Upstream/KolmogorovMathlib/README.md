...
The atlas public library uses Lean's `module` system. Upstream
...
Mathematical statements are upstream's, unchanged. Proofs are upstream's except
in the five files the v4.33.0 migration of 2026-08-31 touched, where proof
scripts were rewritten to build at the new toolchain and nothing else; see
[`toolchain-v4330-migration.md`](../../../docs/provenance/toolchain-v4330-migration.md). Prefer the public aliases in
