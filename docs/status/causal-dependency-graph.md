...
| `behavior` | definition | `Assignment`, `Model`, `ProbMixture`, `Skeleton`, `Skeleton.gap`, `Skeleton.observed` |
| `behaviorEq_iff_behavior_eq` | theorem | `Assignment`, `Model`, `ProbMixture`, `Skeleton`, `Skeleton.BehaviorEq`, `Skeleton.observed`, `behavior` |
...
| `not_knowable_of_behaviorEq` | theorem | `Assignment`, `Model`, `ProbMixture`, `Skeleton`, `Skeleton.BehaviorEq`, `Skeleton.observed`, `behavior` |
