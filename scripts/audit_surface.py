...
SURFACES: tuple[Surface, ...] = (
    ...
    Surface(
        ...
        layer=(
            ...
            "AISafetyAtlas/Examples/SingularLearning.lean",
            "AISafetyAtlas/Examples/SingularLearning/",
            "AISafetyAtlas/Conjectures/MAIS/O77.lean",
            "AISafetyAtlas/Conjectures/MAIS/O77Proof.lean",
            "AISafetyAtlas/Conjectures/MAIS/O77Chart.lean",
            "AISafetyAtlas/Conjectures/MAIS/A7Zeta.lean",
            "AISafetyAtlas/Examples/Conjectures/MAIS/O77.lean",
            "AISafetyAtlas/Examples/Conjectures/MAIS/O77Chart.lean",
            "AISafetyAtlas/Examples/Conjectures/MAIS/A7Zeta.lean",
        ),
        statement_modules=(
            "AISafetyAtlas/Conjectures/MAIS/O77.lean",
            "AISafetyAtlas/Conjectures/MAIS/A7Zeta.lean",
        ...
        conclusion_roots=(
            ...
            "IsO77MinimizerCharacterization",
            "O77AllSaddlesHavePairOne",
            "IsO77FiberVolumeOrderTable",
            "O77FiberDependsOnRanksOnlyAtVolumeOrder",
            "IsO77FiberMinimumTable",
            "IsO77AWValueStratumTable",
            "IsO77MaximumMultiplicityOnMinimizers",
            "o77Pair",
            "o77Minimizers",
            "O77SpectralFrame",
            "IsO77SaddleRungPoint",
        ),
        hypothesis_roots=(
            "EigenvalueLawStatement",
            "eigenvalueLawStatement_iff",
            "A7ZetaVolumeBridge",
            "a7ZetaVolumeBridge_iff",
        ),
        note="part (b) unconditional; part (a) assumes the Wishart eigenvalue law",
    ),
    Surface(
        key="MAIS-O7",
        issue=5,
        problem="Conjecture 3.10",
        layer=(
            "AISafetyAtlas/SingularLearning.lean",
            "AISafetyAtlas/SingularLearning/",
            "AISafetyAtlas/Examples/SingularLearning.lean",
            "AISafetyAtlas/Examples/SingularLearning/",
            "AISafetyAtlas/Conjectures/MAIS/O7.lean",
            "AISafetyAtlas/Conjectures/MAIS/O7Proof.lean",
            "AISafetyAtlas/Conjectures/MAIS/A7Zeta.lean",
            "AISafetyAtlas/Examples/Conjectures/MAIS/O7.lean",
            "AISafetyAtlas/Examples/Conjectures/MAIS/A7Zeta.lean",
        ),
        statement_modules=(
            "AISafetyAtlas/Conjectures/MAIS/O7.lean",
        ...
        note="refutation, unconditional at the volume order; the zeta reading assumes A7-ZETA-BRIDGE",
    ),
    Surface(
        key="MAIS-O38",
        issue=30,
